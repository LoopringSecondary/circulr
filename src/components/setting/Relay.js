...
function Relay(props) {
  ...
  return (
  	<div>
        ...
        <Radio.Group>
	        <Radio value={1}  className="d-flex justify-content-around align-items-center">
			    <Input.Group size="large" className="d-flex justify-content-between">
			        <Col div={6}>
	        ...
	        <Radio value={2}  className="d-flex justify-content-between align-items-center">
	        	    <Input.Group size="large" className="d-flex justify-content-between">
	        	        <Col div={6}>
	        ...
	        <div className="blk"></div>
	        <Radio value={3}   className="d-flex justify-content-between align-items-center ">
	        	    <Input.Group size="large" className="d-flex justify-content-between">
	        	        <Col div={6}>
