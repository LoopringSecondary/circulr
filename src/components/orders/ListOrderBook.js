	    ...
	    <div className="card dark h-full">
	    	...
	    	<div className="trade-list h-full" style={{paddingTop: "114px", marginTop: "-114px" }}>
	    	    <div style={{position: "relative", height: "50%", paddingBottom: "70px" }}>
	    	        ...
	    	        <div className="bg" style={{ position: "absolute", bottom:"0", zIndex: "100", width: "100%", height: "40px", lineHeight: "38px", border:"1px solid rgba(255,255,255,.07)", borderWidth: "1px 0", fontSize: "16px"}}>
