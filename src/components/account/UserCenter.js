            ...
            </div>}
            {
              !(wallet.address) &&  <div className="poweroff text-color-dark" id="powerOff" onClick={() => routeActions.gotoPath('/unlock')}>
    	        ...
    	        <div className="menu">
                    ...
                    {false && wallet.address &&  <li><a onClick={() => dispatch({type:'layers/showLayer',payload:{id:'tradeByP2P'}})}><i className="icon-trade"/><span>{intl.get('p2p_order.user_center_p2p')}</span></a></li>}
