...
export default {
  ...
  wallet: {
    ...
    metamask_unlock_refresh_button: '全做完了？刷新Circular',
    ...
    metamask_unlock_step_refresh_title: '刷新Circular',
    metamask_unlock_step_refresh_content: '刷新Circular钱包使MetaMask生效',
