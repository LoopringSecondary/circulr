...
export default {
  ...
  wallet: {
    ...
    metamask_unlock_refresh_button: 'All Done? Refresh Circular',
    ...
    metamask_unlock_step_refresh_title:'Refresh Circular',
    metamask_unlock_step_refresh_content:'Refresh Circular wallet to enable MetaMask',
    install_metaMask_tip:'Install MetaMask',
    no_address_tip:'No valid addresses',
    connect_ledger_tip:"Please conect to your Ledger钱包",
