...
(function Export(global, factory) {
  ...
  walk =
    '"use strict"; return function(c) {' +
    'var e = c, nodes = [ ], next = e.firstElementChild;' +
    'while ((e = next)) { if (@) { nodes[nodes.length] = e; }' +
    'if ((next = e.firstElementChild || e.nextElementSibling)) continue;' +
    'while (!next && (e = e.parentElement) && e !== c) {' +
    'next = e.nextElementSibling; } } return nodes; }',
