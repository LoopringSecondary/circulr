...
有任何疑问，欢迎提交 [issue](https://github.com/antvis/interaction/issues)，
或者直接修改提交 [PR](https://github.com/antvis/interaction/pulls)!
...
提交后就可以在 [interaction](https://github.com/antvis/interaction/pulls) 创建 Pull Request 了。
...
Document change on antvis/interaction#12
...
interaction 基于 [semver] 语义化版本号进行发布。
