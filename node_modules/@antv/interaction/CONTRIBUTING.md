...
If you have any comment or advice, please report your [issue](https://github.com/antvis/interaction/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/interaction/pulls).
...
Then you can create a Pull Request at [interaction](https://github.com/antvis/interaction/pulls).
...
4. User Tips: Notice for interaction users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on antvis/interaction#123
...
interaction uses semantic versioning in release process based on [semver].
